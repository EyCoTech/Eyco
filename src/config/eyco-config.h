/* src/eyco-config.h.  Generated from eyco-config.h.in by configure.  */
/* src/eyco-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EYCO_CONFIG_H

#define EYCO_CONFIG_H
