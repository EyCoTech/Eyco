...
#ifndef H_EYCO_SCRIPT
#define H_EYCO_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEycoAddress
 */
...
public:
    ...
    // Pre-version-0.6, Eyco always counted CHECKMULTISIGs
