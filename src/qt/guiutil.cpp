...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Eyco.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        // Get a pointer to the IEycoLink interface.
        IShellLink* psl = NULL;
        ...
        if (SUCCEEDED(hres))
        {
            ...
            // Query IEycoLink for the IPersistFile interface for
...
{
    return GetAutostartDir() / "eyco.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Eyco-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  eyco-qt [" + tr("command-line options") + "]                     " + "\n";
