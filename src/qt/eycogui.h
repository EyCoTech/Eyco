...
/**
  Eyco GUI main class. This class represents the main window of the Eyco UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EycoGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit EycoGUI(QWidget *parent = 0);
    ~EycoGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a eyco wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
