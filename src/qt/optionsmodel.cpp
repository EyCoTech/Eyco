...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeEycoAmount"))
        settings.setValue("nAnonymizeEycoAmount", 1000);
    ...
    if (settings.contains("nAnonymizeEycoAmount"))
        SoftSetArg("-anonymizeEycoamount", settings.value("nAnonymizeEycoAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeEycoAmount:
            nAnonymizeEycoAmount = value.toInt();
            settings.setValue("nAnonymizeEycoAmount", nAnonymizeEycoAmount);
            emit anonymizeEycoAmountChanged(nAnonymizeEycoAmount);
            break;
