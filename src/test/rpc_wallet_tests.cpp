// Copyright (c) 2013-2014 The Eyco Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CEycoAddress demoAddress = CEycoAddress(CTxDestination(demoPubkey.GetID()));
    UniValue retValue;
    ...
    CEycoAddress setaccountDemoAddress = CEycoAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CEycoAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CEycoAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
