...
{
    BOOST_CHECK(TestSplitHost("www.eyco.org", "www.eyco.org", -1));
    BOOST_CHECK(TestSplitHost("[www.eyco.org]", "www.eyco.org", -1));
    BOOST_CHECK(TestSplitHost("www.eyco.org:80", "www.eyco.org", 80));
    BOOST_CHECK(TestSplitHost("[www.eyco.org]:80", "www.eyco.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10827", "127.0.0.1", 10827));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10827", "127.0.0.1", 10827));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10827", "::ffff:127.0.0.1", 10827));
    BOOST_CHECK(TestSplitHost("[::]:10827", "::", 10827));
    BOOST_CHECK(TestSplitHost("::10827", "::10827", -1));
    BOOST_CHECK(TestSplitHost(":10827", "", 10827));
    BOOST_CHECK(TestSplitHost("[]:10827", "", 10827));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10827", "127.0.0.1:10827"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10827", "[::]:10827"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
