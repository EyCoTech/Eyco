...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-eyco executable and locales:
...
Section -post SEC0001
    ...
    # eyco: URI handling disabled for 0.6.0
    #    WriteRegStr HKCR "eyco" "URL Protocol" ""
    #    WriteRegStr HKCR "eyco" "" "URL:Eyco"
    #    WriteRegStr HKCR "eyco\DefaultIcon" "" $INSTDIR\eyco-qt.exe
    #    WriteRegStr HKCR "eyco\eyco\open\command" "" '"$INSTDIR\eyco-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Eyco.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\Eyco.lnk"
